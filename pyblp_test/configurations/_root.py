...
from scipy.optimize._optimize import MemoizeJac, OptimizeResult, _check_unknown_options
from scipy.optimize._minpack_py import _root_hybr, leastsq
from pyblp_test.configurations.spectral import _root_df_sane
