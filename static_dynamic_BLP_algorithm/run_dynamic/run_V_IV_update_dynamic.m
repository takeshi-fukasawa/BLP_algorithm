...
for k=1:ITER_MAX
    ...
    S_jt_data,S_0t_data,weigth_V,x_V,beta_C,tune_param);
...
EV=compute_EV_func(V_updated,[],weight_V,x_V,T);
[s_jt_predict,~]=...
...
spec=spec_default;
spec.dim_hetero_spectral_coef=t_dim_id*ones(2,1);
tic
for kk=1:n_sim
        output_spectral=...
...
EV=compute_EV_func(V_sol,[],weight_V,x_V,T);
[s_jt_predict,~]=...
