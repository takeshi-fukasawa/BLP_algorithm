...
if rho_est==0 %%%%%%%%%%%%%%%%%%
    ...
    results_r_mixed_SQUAREM=results_r_SQUAREM;
    results_r_mixed_Anderson=results_r_spectral;
    ...
    results_r_conservative_SQUAREM=results_r_SQUAREM;
    results_r_conservative_Anderson=results_r_Anderson;
...
if isempty(results_r_mixed)==0
    results_temp=[results_temp;...
        ...
        results_table_func(results_r_mixed_Anderson);...        
        ...
        results_table_func(results_r_conservative_Anderson);...
