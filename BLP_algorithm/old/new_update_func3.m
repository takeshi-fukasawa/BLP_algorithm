...
global s_i0_initial s_i0_ccp_initial s_ig_predict weight_predict difference
    ...
    V_initial=log(1+exp((1-rho).*V_hat_initial));
    ...
    %%% Update V_hat themselved
    speed_param=1;
    V_hat_updated=V_hat_initial-speed_param.*difference;%J*1
    
    %%% Based on V update
    V_updated=V_initial_new-(1-rho).*difference;%1*ns
