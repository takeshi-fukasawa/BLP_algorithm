...
results_temp=[mean(results_BLP_0,1);mean(results_BLP_0_spectral,1);mean(results_BLP_0_SQUAREM,1);...
    mean(results_BLP_1,1);mean(results_BLP_1_spectral,1);mean(results_BLP_1_SQUAREM,1);...
    mean(results_V_0,1);mean(results_V_0_spectral,1);mean(results_V_0_SQUAREM,1);...
    mean(results_V_1,1);mean(results_V_1_spectral,1);mean(results_V_1_SQUAREM,1)];
...
elseif rho_est>0
    results_temp=[mean(results_BLP_0,1);mean(results_BLP_0_spectral,1);mean(results_BLP_0_SQUAREM,1);...
    mean(results_BLP_1,1);mean(results_BLP_1_spectral,1);mean(results_BLP_1_SQUAREM,1);...
    mean(results_IV_0,1);mean(results_IV_0_spectral,1);mean(results_IV_0_SQUAREM,1);...
    mean(results_IV_1,1);mean(results_IV_1_spectral,1);mean(results_IV_1_SQUAREM,1)];
end
