...
for kk=1:n_sim
    ...
    if GPU_spec==1
        output_spectral=...
        spectral_func(@r_update_RCL_func,1,r_initial0,...
        [],[],...
        ...
        output_spectral=...
        spectral_func_cpu(@r_update_RCL_func,1,r_initial0,...
        [],[],...
        weight,mu_ijt_est,rho_est,...
