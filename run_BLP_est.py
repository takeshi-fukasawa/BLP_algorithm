...
with open(output_path+'BLP_est_results_Anderson_1_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
  pickle.dump(results_Anderson_1, fo)

## Anderson-1-numer-diff
iteration=pyblp_test.Iteration('Anderson_acceleration',{'atol':1e-14,'scheme':2,'mem_size':5},new_delta_mapping=True)

results_Anderson_1_numer_diff = problem.solve(initial_sigma,
    initial_pi,iteration=iteration,optimization=optimization,costs_bounds=(0.001, None),
    W_type='clustered', se_type='clustered',initial_update=True,check_optimality='gradient',finite_differences=True)

with open(output_path+'BLP_est_results_Anderson_1_numer_diff_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
...
results_simple_1 = problem.solve(initial_sigma,
                                 initial_pi,iteration=iteration,optimization=optimization,costs_bounds=(0.001, None),W_type='clustered', se_type='clustered',initial_update=True,
                                 check_optimality='gradient',finite_differences=False)

with open(output_path+'BLP_est_results_simple_1_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
...
with open(output_path+'BLP_est_results_Anderson_0_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
...
with open(output_path+'BLP_est_results_spectral_0_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
...
with open(output_path+'BLP_est_results_squarem_0_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
...
results_squarem_0_numer_diff = problem.solve(initial_sigma,
    initial_pi,iteration=iteration,optimization=optimization,costs_bounds=(0.001, None),
    W_type='clustered', se_type='clustered',initial_update=True,
    check_optimality='gradient',finite_differences=True)

with open(output_path+'BLP_est_results_squarem_0_numer_diff_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
...
with open(output_path+'BLP_est_results_simple_0_trial_'+str(trial_id)+'.pickle', mode='wb') as fo:
...
with open(output_path+'BLP_est_results_Anderson_1_numer_diff_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_Anderson_1_numer_diff = pickle.load(fi)

with open(output_path+'BLP_est_results_spectral_1_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_spectral_1 = pickle.load(fi)

with open(output_path+'BLP_est_results_squarem_1_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_squarem_1 = pickle.load(fi)

with open(output_path+'BLP_est_results_Anderson_0_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_Anderson_0 = pickle.load(fi)

with open(output_path+'BLP_est_results_spectral_0_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_spectral_0 = pickle.load(fi)

with open(output_path+'BLP_est_results_squarem_0_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_squarem_0 = pickle.load(fi)


with open(output_path+'BLP_est_results_squarem_0_numer_diff_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_squarem_0_numer_diff = pickle.load(fi)

with open(output_path+'BLP_est_results_simple_1_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
  results_simple_1 = pickle.load(fi)

with open(output_path+'BLP_est_results_simple_0_trial_'+str(trial_id)+'.pickle', mode='br') as fi:
...
with open(output_path+'BLP_est_results_trial_'+str(trial_id)+'.csv', 'w',newline="") as f:
    writer = csv.writer(f)
